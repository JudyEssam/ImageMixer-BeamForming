...
class BeamForming:
    ...
    def find_interference_map(self):
        ...
        distances = np.linspace(0.1, 5, range_points)  # Distance range (0.1 to 10 meters)
        ...
        im = ax.pcolormesh(azimuth, distances, intensity_map.T, shading='auto', cmap='viridis')  # Transpose for pcolormesh
